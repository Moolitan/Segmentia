...
if (($#)); then
  echo "This sweep takes no command-line arguments; edit packed_chunks_single_layer_completion_config.py." >&2
  exit 2
fi
...
export CSKCACHE_COMPLETION_SWEEP_CONFIG="packed_chunks_single_layer_completion_config"
export MPLCONFIGDIR="/tmp/cskcache-packed-chunks-single-layer-completion-matplotlib"
